...
utils.settings.running_tick =
	tonumber(minetest.settings:get("lwscratch_running_tick") or 0)

utils.settings.robot_move_delay =
	tonumber(minetest.settings:get("lwscratch_robot_move_delay") or 0)

utils.settings.robot_action_delay =
	tonumber(minetest.settings:get("lwscratch_robot_action_delay") or 0)
...
if utils.settings.robot_move_delay < 0 then
	utils.settings.robot_move_delay = 0
end

if utils.settings.robot_action_delay < 0 then
	utils.settings.robot_action_delay = 0
end
